...
## RAG flow / Flujo RAG
1. Load the selected client's PDF from `DOCS_PATH`.
2. Split into chunks with overlap for better recall.
3. Embed with OpenAI and store in persisted Chroma collections per client.
4. Retrieve top-K relevant chunks.
5. Build prompt and query ChatOpenAI, answering in the language of the question.
6. Return the answer plus the context chunks (text, source, page).
